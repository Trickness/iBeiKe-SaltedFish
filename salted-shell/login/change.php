    ...
    <div class="container win">
        <div id="reset" class="col-sm-4 col-sm-offset-4 login">
            ...
            <div style="padding-bottom:10px;">
                <div style="margin-top:20px;"><input type="password" class="form-control input-lg" placeholder="请输入您的旧密码" v-model="password" /></div>
                ...
                <div style="margin-top:20px;"><button class="btn btn-lg btn-warning" style="width:100%;" @click="reset">修改密码</button></div>
            </div>
        </div>
    </div>
                ...
                methods:{
                    reset:function(){
                        ...
                        if (t.check_blank == false) {
                            ...
                            $.post('../core/api-v1.php?action=change_password',{
